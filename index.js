...
// Import routes
import userRoutes from "./routes/auth.route.js"; // Ganti ke auth.route.js jika itu yang Anda maksud untuk user/auth
...
const startServer = async () => {
  try {
    ...
    // Middleware untuk parsing JSON body dan URL-encoded data
    ...
    // Tambahkan SEMUA URL frontend Anda yang akan mengakses API ini.
    // Ini termasuk URL lokal (untuk development) dan URL publik (untuk deployment).
    const allowedOrigins = [
      "http://localhost:5173", // Admin Panel Lokal
      "http://localhost:3001", // Frontend Klien Lokal
      "https://kelurahansendangmulyo-admin.vercel.app", // Admin Panel Vercel (Ganti dengan URL Vercel Anda yang sebenarnya)
      "https://kelurahansendangmulyo.vercel.app",     // Frontend Klien Vercel (Ganti dengan URL Vercel Anda yang sebenarnya)
      // Tambahkan URL lain jika ada (misal: domain kustom Anda jika nanti pakai)
    ];
